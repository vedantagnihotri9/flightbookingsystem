...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cin >> doj;
        cout << "\1.Delhi(1) \t\2.Mumbai(2) \t\3.Chennai(3) \t\4.Goa(4)" << endl << endl;
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        cin >> doji;
        cout << "\1.London(1) \2.Dubai(2) \3.Vietnam(3) \4.Singapore(4) \5.NewYork(5) " << endl << endl;
        cout << "\tEnter Source" << endl;
        cin >> srci;
        cout << "\nEnter destination" ;
        cin >> desti;
...
{
protected:
    long int card,user_id;
    int choice1,bank,date,cvv;
    char password[10], upi_id[20];
public:
    void pay_detail()
    {     cout << "\n\n\nMode Of Payment\n";
        cout << "\n\1.Debit Card(1) \n\2.Credit Card(2) \n\3.Net Banking(3) \n\4.UPI Transfer(4)\n";
        ...
        case 2:
            ...
            break;
        case 3:
            cout << "Banks Available: \1.State Bank Of India(1) \2.ICICI Bank(2) \3.Standard Chartered Bank(3) \4.HDFC Bank(4) \5.Others(5)";
            cout << "\nSelect your bank:";
            cin >> bank;
        ...
        case 4:
            cout<< "Enter UPI ID:";
            cin>> upi_id;
            cout<< "\nApprove at your UPI Portal";
            cout<< "\nTransanction Successful\n";
            break;
        default:
            cout << "\nWrong input entered.\nTry again\n\n";
            return pay_detail();
